...
import example.com.tugasakhir020irham011yuni.Kirim.KSQ7;
import example.com.tugasakhir020irham011yuni.R;

public class CO5Hari7 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_co5_hari7);
        btselamat = findViewById(R.id.btnbelanja007);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja007:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KSQ7.class);

...
import example.com.tugasakhir020irham011yuni.Kirim.KMENARA19;
import example.com.tugasakhir020irham011yuni.R;

public class COMenara19 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comenara19);
        btselamat = findViewById(R.id.btnbelanja019);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja019:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KMENARA19.class);

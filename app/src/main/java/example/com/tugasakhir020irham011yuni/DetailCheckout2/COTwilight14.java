...
import example.com.tugasakhir020irham011yuni.Kirim.KTWILIGHT14;
import example.com.tugasakhir020irham011yuni.R;

public class COTwilight14 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cotwilight14);
        btselamat = findViewById(R.id.btnbelanja014);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja014:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KTWILIGHT14.class);

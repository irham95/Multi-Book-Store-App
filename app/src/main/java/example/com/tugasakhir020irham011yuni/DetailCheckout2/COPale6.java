...
import example.com.tugasakhir020irham011yuni.Kirim.KPALE6;
import example.com.tugasakhir020irham011yuni.R;

public class COPale6 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_copale6);
        btselamat = findViewById(R.id.btnbelanja006);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja006:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KPALE6.class);

...
import example.com.tugasakhir020irham011yuni.Kirim.KFAULT16;
import example.com.tugasakhir020irham011yuni.R;

public class COFault16 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cofault16);
        btselamat = findViewById(R.id.btnbelanja016);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja016:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KFAULT16.class);

...
import example.com.tugasakhir020irham011yuni.Kirim.KHH4;
import example.com.tugasakhir020irham011yuni.R;

public class COH4 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coh4);
        btselamat = findViewById(R.id.btnbelanja004);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja004:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KHH4.class);

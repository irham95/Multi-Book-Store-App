...
import example.com.tugasakhir020irham011yuni.Kirim.KHBP3;
import example.com.tugasakhir020irham011yuni.R;

public class COHP3 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cohp3);
        btselamat = findViewById(R.id.btnbelanja003);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja003:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KHBP3.class);

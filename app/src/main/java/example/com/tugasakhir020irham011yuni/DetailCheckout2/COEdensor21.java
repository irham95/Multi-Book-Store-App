...
import example.com.tugasakhir020irham011yuni.Kirim.KEDENSOR21;
import example.com.tugasakhir020irham011yuni.R;

public class COEdensor21 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coedensor21);
        btselamat = findViewById(R.id.btnbelanja021);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja021:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KEDENSOR21.class);

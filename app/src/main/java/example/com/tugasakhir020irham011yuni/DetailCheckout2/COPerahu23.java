...
import example.com.tugasakhir020irham011yuni.Kirim.KPERAHU23;
import example.com.tugasakhir020irham011yuni.R;

public class COPerahu23 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coperahu23);
        btselamat = findViewById(R.id.btnbelanja023);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja023:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KPERAHU23.class);

...
import example.com.tugasakhir020irham011yuni.Kirim.KirimDaddy1;
import example.com.tugasakhir020irham011yuni.R;

public class DetailCheckoutDaddyOut1 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_checkout_daddy_out1);
        btselamat = findViewById(R.id.btnbelanja001);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja001:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KirimDaddy1.class);

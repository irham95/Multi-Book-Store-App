...
import example.com.tugasakhir020irham011yuni.Kirim.KAND8;
import example.com.tugasakhir020irham011yuni.R;

public class COAnd8 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coand8);
        btselamat = findViewById(R.id.btnbelanja008);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja008:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KAND8.class);

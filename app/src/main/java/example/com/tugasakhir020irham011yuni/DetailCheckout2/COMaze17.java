...
import example.com.tugasakhir020irham011yuni.Kirim.KMAZE17;
import example.com.tugasakhir020irham011yuni.R;

public class COMaze17 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comaze17);
        btselamat = findViewById(R.id.btnbelanja017);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja017:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KMAZE17.class);

...
import example.com.tugasakhir020irham011yuni.Kirim.KHaunted11;
import example.com.tugasakhir020irham011yuni.R;

public class COHaunted11 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cohaunted11);
        btselamat = findViewById(R.id.btnbelanja011);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja011:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KHaunted11.class);

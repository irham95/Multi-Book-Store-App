...
import example.com.tugasakhir020irham011yuni.Kirim.KHHARRY12;
import example.com.tugasakhir020irham011yuni.R;

public class COHarpot12 extends AppCompatActivity implements View.OnClickListener {
    Button btselamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coharpot12);
        btselamat = findViewById(R.id.btnbelanja012);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnbelanja012:
                Toast.makeText(this, "Selamat", Toast.LENGTH_SHORT).show();
                Intent intentBeliBuku = new Intent(this, KHHARRY12.class);
